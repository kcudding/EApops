...
xtab=kable(psurv, row.names=FALSE, format="html", table.attr = "style='width:40%;'",
   caption="Number of EA survey responents with self-reported year of joining")
...
regco=kable(t(regout), digits=2,format="html", table.attr = "style='width:60%;'",
   caption="Linear regression for natural log of EA survey responents vs survey year (assumes observation error only)")
...
par(mfrow=c(1,2))
dplo=statictab[[1]]
plot(dplo$years,dplo$num, pch=16, xlab="years as EA", type="b",ylab="# responents")
...
#plot(dplo$years+2,dplo$num, pch=16, xlab="years #as EA", type="b",ylab="ln responents",log="y",
